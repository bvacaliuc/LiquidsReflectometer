...
# Example usage
db.savepath = (
    "/SNS/REF_L/shared/lr_reduction/new_workflow_test_outputs/"  # Set the directory where you want to save the output
)
...
DB_out = db.create_db(run_list=run_list, save_name="direct_beam_test.dat", plot=True, flip_atten=True)
