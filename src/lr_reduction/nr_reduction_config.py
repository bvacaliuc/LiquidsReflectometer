...
class NRReductionConfig:
    ...
    def __init__(self):
        ...
        self.qmax = 0.5
        self.dqbin = 0.005
        self.Qline_threshold = (
            1.0  # Fraction of q-line required to be within the bin to be included in the non-constantTOF mode.
        )

        self.LambdaMin = (
            None  # If None this will be calculated from the chopper ranges. If supplied should be an array.
        )
        self.LambdaMax = None
        ...
        self.IncidentTheta = (
            4.0  # degrees Angle of the beamline relative to earth. Positive is downwards. Will become PV.
        )
        self.emission_coefficients = None  # TOF emission time coefficients
        self.use_emission_time = (
            True  # Toggles application of the emission time correction and which distance is to be used.
        )
